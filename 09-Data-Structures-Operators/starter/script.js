...
capitalizeName('colin cavanaugh');
...
console.log(maskCreditCard(6467836));
console.log(maskCreditCard(433415731095318));
console.log(maskCreditCard('133515314312443111245612'));
...
///////// The rest pattern can be used where we would otherwise write variable names separated by commas(,) NOT values separated by commas(,)
/*
/////////////////////////////////////////////////////////////////////
// The Spread Operator (...)
...
// Iterabbles: arrays, strings, maps, sets, NOT objects
const str = 'Jonas';
const letters = [...str, ' ', 'S.'];
console.log(letters);
console.log(...str);
...
const arr = restaurant.orderDelivery({
  time: '22:30',
